...
function Cfg_entities_datas.GetByKey(key)
	if Cfg_entities_datas[key] == nil then
		LogError('Cfg_entities_datas 配置没有key对应:',key)
	end
	return Cfg_entities_datas[key]
end
